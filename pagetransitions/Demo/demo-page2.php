...
<html lang="fr">
	<head>
		<meta charset="utf-8">
		<meta name="description" content="demo simples transitions entre les pages du site">
		<meta name="author" content="Jean-Christophe Rangon">
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		
		<title>Page Transitions|Demo</title>
...
<!--  Inclusion du CSS-->
	...
	<body class="<?=$jcr_page_transition;?>">
		<h1>Page 2</h1>
		<div>
		<div style="width:25%;padding:0 25px;text-align:left;float:left"><a href="./demo-page1.php"><< page 2</a></div>
		<div style="width:25%;padding:0 25px;text-align:right;float:right"><a href="./demo-page3.php"> page 3 >></a></div>
		<div style="clear:both"></div>
		</div>
		<section style="width:80%;margin:0 auto;min-height:90vh;border:1px solid #333;background:#eee;padding:20px 10px;">
			<h2>section1</h2>
			<p>
				<div style="display:inline-block;width:200px;height:300px;background:blue;padding:40px; border:1px solid #333;float:right;"></div>
